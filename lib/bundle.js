...
var ScreenManager = function () {
	function ScreenManager() {
		...
		for (var i = 0; i < 3; i++) {
			...
			var _ref3 = [0.5, 0.5];
			this.lives[i].scaleX = _ref3[0];
			this.lives[i].scaleY = _ref3[1];
		}
		var _ref4 = [663, 58];
		this.lives[0].x = _ref4[0];
		this.lives[0].y = _ref4[1];
		var _ref5 = [693, 58];
		this.lives[1].x = _ref5[0];
		this.lives[1].y = _ref5[1];
		var _ref6 = [723, 58];
		this.lives[2].x = _ref6[0];
		this.lives[2].y = _ref6[1];
	}
