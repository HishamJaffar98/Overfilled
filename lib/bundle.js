...
var ScreenManager = function () {
	function ScreenManager() {
		...
		for (var i = 0; i < 3; i++) {
			...
			var _ref5 = [0.5, 0.5];
			this.lives[i].scaleX = _ref5[0];
			this.lives[i].scaleY = _ref5[1];
		}
		var _ref6 = [663, 58];
		this.lives[0].x = _ref6[0];
		this.lives[0].y = _ref6[1];
		var _ref7 = [693, 58];
		this.lives[1].x = _ref7[0];
		this.lives[1].y = _ref7[1];
		var _ref8 = [723, 58];
		this.lives[2].x = _ref8[0];
		this.lives[2].y = _ref8[1];
	}
	...
	_createClass(ScreenManager, [{
		...
		value: function updateScore(currentScore) {
			...
			this.highScoreText = new createjs.Text('High   Score: ' + this.highScore, this.text_font, this.text_color);
			var _ref9 = [580, 15];
			this.highScoreText.x = _ref9[0];
			this.highScoreText.y = _ref9[1];

			this.currentScoreText = new createjs.Text('Score: ' + this.currentScore, this.text_font, this.text_color);
			var _ref10 = [580, 35];
			this.currentScoreText.x = _ref10[0];
			this.currentScoreText.y = _ref10[1];
		...
		value: function levelWon() {
			...
			var _ref11 = [385, 275];
			LEVEL_TEXT.x = _ref11[0];
			LEVEL_TEXT.y = _ref11[1];

			var LEVEL_TEXT_2 = newcreatejs.Text('Level ' + this.levelNum, '46px ARCADECLASSIC', '#00b9fb');
			var _ref12 = [388, 278];
			LEVEL_TEXT_2.x = _ref12[0];
			LEVEL_TEXT_2.y = _ref12[1];
		...
		value: function lifeLost() {
			...
			var _ref13 = [23, 0.9525];
			LIFE_LOST.x = _ref13[0];
			LIFE_LOST.scaleX = _ref13[1];
		...
		value: function gameOver() {
			...
			var _ref14 = [23, 0.9525];
			GAME_OVER.x = _ref14[0];
			GAME_OVER.scaleX = _ref14[1];
...
var Customer = function () {
	...
	_createClass(Customer, [{
		...
		value: function CreateCustomers(positions, imagePaths, xLimits) {
			...
			createjs.Tween.get(this.customerSprite, { loop: false }).to({ x: xLimits[randomNumber] }, walkSpeed, createjs.Ease.getPowInOut(1));
