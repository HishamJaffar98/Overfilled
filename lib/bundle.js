...
var CustomerManager = function () {
  ...
  _createClass(CustomerManager, [{
    ...
    value: function createCustomer() {
      ...
      var IMAGE_PATHS = ['assets/cake.png', 'assets/cake.png', 'assets/cake.png'];
      ...
      var VALUES = [RANDOM_SPEED, RANDOM_BAR_INDEX, _bar.BARS[RANDOM_BAR_INDEX].posXLimits[0], _bar.BARS[RANDOM_BAR_INDEX].startPosY + 20, _bar.BARS[RANDOM_BAR_INDEX].scale, _bar.BARS[RANDOM_BAR_INDEX].scale, [], 50];
